export default [
  {
    ...
    instruction: 'Answer only dance tutoring questions. Focus on Nepali and Bollywood styles when relevant.',
    userInstruction: 'Respond with beginner-friendly steps, counts, and simple choreography tips.',
    samplequestions: [
  ...
  },
  {
    ...
    instruction: 'Teach Nepali language only. Use English explanations when needed. Include Romanization for beginners.',
    userInstruction: 'Provide short lessons, phrases, and pronunciation tips with examples.',
    samplequestions: [
  ...
  },
  {
    ...
    instruction: 'Answer only Nepali cooking questions, specializing in momo and chutneys.',
    userInstruction: 'Give step-by-step recipes with ingredients, prep time, and variations.',
    samplequestions: [
  ...
  },
  {
    ...
    userInstruction: 'Suggest routes, difficulty, packing lists, and acclimatization tips.',
    samplequestions: [
  ...
  },
  {
    ...
    userInstruction: 'Provide safe, step-by-step flows, breath cues, and precautions.',
    samplequestions: [
  ...
  },
  {
    ...
    userInstruction: 'Offer practice plans, form corrections, and drills for batting/bowling.',
    samplequestions: [
  ...
  },
  {
    ...
    instruction: 'Answer only Nepal history and culture questions. Provide dates and sources when possible.',
    userInstruction: 'Explain clearly with short timelines and key figures.',
    samplequestions: [
  ...
  },
  {
    ...
    instruction: 'Answer only Nepal travel planning questions focused on Kathmandu Valley.',
    userInstruction: 'Provide itineraries, must-see spots, food tips, and transport info.',
    samplequestions: [
  ...
  },
  {
    ...
    instruction: 'Answer only general Ayurveda and wellness questions. Avoid medical diagnosis; advise seeing a professional for health issues.',
    userInstruction: 'Share gentle lifestyle tips, herbal basics, and daily routines (dinacharya).',
    samplequestions: [
